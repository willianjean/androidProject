...
public class MainActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//botão para setar a data de nascimento
...
//		});
	...
	public void mostraJanelaHabilitacao(){
		...
		builder.setTitle("Quanto falta para tirar a carteira de habilitação?");
		Calendar calendar = Calendar.getInstance();
		if((calendar.get(Calendar.YEAR)-ano)>=18)
			builder.setMessage("Você ja pode tirar sua habilitação");
	...
	public void mostraJanelaAposentadoria(){
		...
		if((calendar.get(Calendar.YEAR)-ano)>=65)
			builder.setMessage("Você ja pode se aposentar");
